...
import {LoganimationsIcon, SendIcon, AttachemntIcon, AIsearchIcon, DOCIcon, PDFIcon, LogIcon, EditIcon } from './icons';
          ...
          <div className='flex flex-row justify-start w-full'>
            <div className='flex flex-row items-top gap-4 '>
                ...
                <div className='bg-white border border-solid border-gray-100 p-4 text-base rounded-md'>
                    👋,Hey David Brown  hope you are good today! <br></br>
